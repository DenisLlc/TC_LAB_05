...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DOSPUNTOS = 3,                  /* DOSPUNTOS  */
  YYSYMBOL_YYACCEPT = 4,                   /* $accept  */
  YYSYMBOL_parentesis = 5                  /* parentesis  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DOSPUNTOS", "$accept",
  "parentesis", YY_NULLPTR
};
