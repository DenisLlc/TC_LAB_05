...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_APERTURA = 3,                   /* APERTURA  */
  YYSYMBOL_CIERRE = 4,                     /* CIERRE  */
  YYSYMBOL_YYACCEPT = 5,                   /* $accept  */
  YYSYMBOL_parentesis = 6                  /* parentesis  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "APERTURA", "CIERRE",
  "$accept", "parentesis", YY_NULLPTR
};
